  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-6 pt-20 overflow-auto">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-pink-500/10 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1s' }} />
      </div>

      <div className="w-full max-w-[580px] animate-fade-in-up">
        <div className="relative p-8 md:p-10 rounded-[32px] bg-gradient-to-b from-white/[0.08] to-white/[0.02] backdrop-blur-2xl border border-white/[0.08] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.5)]">
          ...
          <div className="text-center mb-8">
            <div className="relative w-20 h-20 mx-auto mb-6">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl rotate-6 opacity-50" />
              <div className="relative w-full h-full flex items-center justify-center bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl shadow-lg shadow-purple-500/25">
            ...
            <h1 className="text-3xl md:text-[32px] font-bold mb-3 bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent">
              Image to 3D
            </h1>
            <p className="text-white/50 text-[15px] max-w-xs mx-auto">
          ...
          <div className="space-y-5">
              ...
              <div className="relative group">
                <div className="relative overflow-hidden rounded-2xl border-2 border-white/10">
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <button
                      onClick={handleReset}
                      className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-xl text-white text-sm font-medium hover:bg-white/20 transition-all"
                    >
              ...
              >
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-white/40">JPG, PNG, WebP • Max 10MB</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <button
              ...
              className={`relative w-full py-4 rounded-xl text-base font-semibold transition-all duration-300 overflow-hidden group
                ${selectedFile
            ...
            {error && (
              <div className="flex items-center gap-2 px-4 py-3 bg-red-500/10 rounded-xl text-red-400 text-sm animate-fade-in">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="flex items-center justify-center gap-3 mt-6 flex-wrap">
          {['100% Free', 'Client-Side', 'Export GLB'].map((feature) => (
            <span key={feature} className="px-3 py-1.5 text-xs font-medium text-white/40 bg-white/5 rounded-full border border-white/5">
              {feature}
            </span>
          ))}
        </div>
